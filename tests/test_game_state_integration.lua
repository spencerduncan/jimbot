...
function test_runner.test_available_actions_comprehensive()
    ...
    for _, state_value in ipairs(pack_states) do
        ...
        assert_not_nil(
            actions,
            string.format("Actions should not be nil for state %d", state_value)
        )
    end
end
...
function test_runner.test_unknown_state_logging()
    ...
    assert_equals(
        state.game_state,
        "UNKNOWN_STATE_999",
        "Unknown state should be reported correctly"
    )
...
function test_runner.run_all_tests()
    ...
    run_test(
        "test_available_actions_comprehensive",
        test_runner.test_available_actions_comprehensive
    )
