...
class BalatroCallbacks(DefaultCallbacks):
    ...
    def on_episode_end(
        ...
        **kwargs
        ...
        episode.custom_metrics["jokers_activated"] = episode.user_data["jokers_activated"]
        episode.custom_metrics["rounds_completed"] = episode.user_data["rounds_completed"]
    ...
    def on_sample_end(self, *, worker: RolloutWorker, samples: Dict[str, Any], **kwargs):
