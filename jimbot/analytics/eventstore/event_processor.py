...
from jimbot.shared.interfaces.analytics_pb2 import GameEvent, SystemEvent
...
class EventProcessor:
    ...
    def _define_event_schemas(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "GameEnded": {
                "category": EventCategory.GAME,
                "required_fields": ["game_id", "final_score", "rounds_survived", "outcome"],
                "stream_prefix": "game-"
            },
            ...
            "DecisionMade": {
                ...
                "required_fields": ["game_id", "decision_type", "action", "state_summary"],
            ...
            "ModelCheckpoint": {
                ...
                "required_fields": ["model_version", "training_iteration", "performance_metrics"],
                "stream_prefix": "system-"
            },
            "ComponentError": {
                "category": EventCategory.SYSTEM,
                "required_fields": ["component", "error_type", "error_message", "recovery_action"],
                "stream_prefix": "system-"
            },
            ...
            "TrainingStep": {
                ...
                "required_fields": ["iteration", "loss", "learning_rate", "samples_processed"],
                "stream_prefix": "training-"
            },
            "StrategyUpdate": {
                "category": EventCategory.TRAINING,
                "required_fields": ["old_strategy", "new_strategy", "reason", "performance_delta"],
                "stream_prefix": "training-"
            }
        }
    ...
    async def _update_game_tracking(self, event: Event):
        ...
        if event.event_type == "GameStarted":
            ...
            if event.event_type == "GameEnded":
                ...
                logger.info(f"Game {game_id} completed: {game_info['events']} events, "
    ...
    async def store_event(self, stream: str, event_type: str, 
...
class GameReplayer:
    ...
    def _update_game_state(self, state: Dict[str, Any], 
        ...
        if event_type == "RoundStarted":
            ...
            state["jokers"].append({
                "name": data.get("joker_name"),
                "position": data.get("slot_position")
            })
