...
class ProtobufSerializer:
    ...
    def _register_default_types(self):
        ...
        try:
            ...
            self.register_type(balatro_events_pb2.LearningDecisionRequest, "LearningDecisionRequest")
            self.register_type(balatro_events_pb2.LearningDecisionResponse, "LearningDecisionResponse")
    ...
    def serialize(self, message: Any, format: Optional[SerializationFormat] = None) -> bytes:
    ...
    def deserialize(self, data: bytes, type_name: str, 
    ...
    def convert_format(self, message: Any, from_format: SerializationFormat,
                      to_format: SerializationFormat) -> Any:
    ...
    def set_json_compatibility_mode(self, strict: bool = False, 
