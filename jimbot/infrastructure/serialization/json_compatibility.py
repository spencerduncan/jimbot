...
class JsonCompatibilityLayer:
    ...
    def json_to_proto(self, json_event: Dict[str, Any]) -> Optional[Message]:
        ...
        try:
            ...
            proto_event.timestamp = json_event.get("timestamp", int(datetime.now().timestamp() * 1000))
            ...
            if proto_type_name != "EVENT_TYPE_CUSTOM":
                ...
                proto_event.custom_event.Pack(self._json_to_any(json_event.get("payload", {})))
    ...
    def _map_payload(self, json_event: Dict[str, Any], proto_event: Message, proto_type: str):
    ...
    def _map_card(self, json_card: Dict[str, Any], proto_card: Message):
        ...
        rank_map = {
            "A": "RANK_ACE", "1": "RANK_ACE", "ACE": "RANK_ACE",
            "2": "RANK_TWO", "3": "RANK_THREE", "4": "RANK_FOUR",
            "5": "RANK_FIVE", "6": "RANK_SIX", "7": "RANK_SEVEN",
            "8": "RANK_EIGHT", "9": "RANK_NINE", "10": "RANK_TEN",
            "J": "RANK_JACK", "JACK": "RANK_JACK",
            "Q": "RANK_QUEEN", "QUEEN": "RANK_QUEEN",
            "K": "RANK_KING", "KING": "RANK_KING"
        }
        proto_card.rank = getattr(balatro_events_pb2.Rank, rank_map.get(rank_str, "RANK_UNSPECIFIED"))
        
        # Map suit
        suit_str = str(json_card.get("suit", "")).upper()
        suit_map = {
            "S": "SUIT_SPADES", "SPADES": "SUIT_SPADES",
            "H": "SUIT_HEARTS", "HEARTS": "SUIT_HEARTS",
            "C": "SUIT_CLUBS", "CLUBS": "SUIT_CLUBS",
            "D": "SUIT_DIAMONDS", "DIAMONDS": "SUIT_DIAMONDS"
        }
        proto_card.suit = getattr(balatro_events_pb2.Suit, suit_map.get(suit_str, "SUIT_UNSPECIFIED"))
    ...
    def _map_action(self, json_action: Dict[str, Any], proto_action: Message):
        ...
        if action_type == "play_hand":
            proto_action.play_hand.card_indices.extend(json_action.get("card_indices", []))
        elif action_type == "discard":
            proto_action.discard.card_indices.extend(json_action.get("card_indices", []))
    ...
    def _extract_unknown_fields(self, json_event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        known_fields = {
            "type", "source", "timestamp", "event_id", "priority",
            "game_id", "session_id", "sequence_number", "payload",
            "metadata", "version"
        }
