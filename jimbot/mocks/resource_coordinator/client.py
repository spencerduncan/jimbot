...
class ResourceCoordinatorClient:
    ...
    def request_gpu(self, 
                   ...
                   metadata: Optional[Dict[str, str]] = None) -> Tuple[bool, str, Optional[str]]:
    ...
    def _request_resource(self,
                         ...
                         metadata: Optional[Dict[str, str]]) -> Tuple[bool, str, Optional[str]]:
        ...
        request.priority = priority_map.get(priority.upper(), resource_coordinator_pb2.PRIORITY_NORMAL)
    ...
    def get_status(self, resource_type: Optional[str] = None) -> Dict:
        ...
        if resource_type:
            ...
            request.resource = type_map.get(resource_type.upper(), 
        ...
        try:
            ...
            for status in response.statuses:
                resource_name = resource_coordinator_pb2.ResourceType.Name(status.resource)
