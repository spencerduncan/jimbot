...
class TestDynamicObservationSpace:
    ...
    def sample_cards(self) -> list[Card]:
        ...
        return [
            ...
            Card(
                CardSuit.CLUBS, CardRank.TWO, CardEnhancement.GLASS, CardSeal.RED_SEAL
            ),
    ...
    def sample_jokers(self) -> list[Joker]:
        ...
        return [
            Joker(
                joker_id=1,
                level=3,
                edition=CardEdition.HOLOGRAPHIC,
                sell_value=8,
                position=0,
            ),
            Joker(
    ...
    def test_card_encoding(self, obs_space, sample_cards):
        ...
        features, mask = obs_space._encode_cards(
            sample_cards, 10, location="hand", selected_indices={0, 2}
        )
    ...
    def test_extreme_game_state(self, obs_space):
        ...
        # Create 150 cards
        huge_hand = [Card(CardSuit(i % 4), CardRank((i % 13) + 1)) for i in range(150)]

        # Create 25 jokers
        many_jokers = [Joker(joker_id=i, level=1, position=i) for i in range(25)]
    ...
    def test_mixed_card_dict_input(self, obs_space):
        ...
        game_state = {"hand": mixed_hand, "deck": [], "jokers": [], "money": 10}
    ...
    def test_padding_overflow(self, obs_space):
        ...
        overflow_hand = [Card(CardSuit.HEARTS, CardRank.ACE) for _ in range(250)]

        game_state = {"hand": overflow_hand, "deck": [], "jokers": []}
    ...
    def test_special_card_types(self, obs_space):
        ...
        special_cards = [
            ...
            Card(
                ...
                edition=CardEdition.NEGATIVE,
            ),
            Card(
                CardSuit.DIAMONDS,
                CardRank.KING,
                CardEnhancement.LUCKY,
                seal=CardSeal.PURPLE_SEAL,
            ),
        ]
