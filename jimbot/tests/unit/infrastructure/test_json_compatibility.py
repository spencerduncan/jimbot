...
from jimbot.infrastructure.serialization.json_compatibility import JsonCompatibilityLayer
...
class TestJsonCompatibilityLayer:
    ...
    def test_json_to_proto_basic_fields(self, mock_pb2, compat_layer, sample_json_event):
    ...
    @patch('jimbot.infrastructure.serialization.json_compatibility.balatro_events_pb2')
    def test_json_to_proto_learning_request(self, mock_pb2, compat_layer, sample_learning_request):
    ...
    def test_proto_to_json_basic(self, compat_layer):
        ...
        # Mock json_format
        with patch('jimbot.infrastructure.serialization.json_compatibility.json_format') as mock_format:
    ...
    def test_batch_json_to_proto(self, compat_layer):
        ...
        with patch('jimbot.infrastructure.serialization.json_compatibility.balatro_events_pb2') as mock_pb2:
