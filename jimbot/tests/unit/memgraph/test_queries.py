...
class TestJokerSynergyQuery:
    ...
    def test_finds_direct_synergies(self, query_engine):
        ...
        query_engine.client.execute_query.return_value = [
            {"joker": "Baseball Card", "synergy": 0.8, "reason": "Both scale with cards"},
...
class TestStrategyAnalyzer:
    ...
    def test_identifies_winning_patterns(self, analyzer):
        ...
        analyzer.client.execute_query.return_value = [
            {
                "pattern": "early_economy_focus",
                "success_rate": 0.75,
                "occurrences": 45
            },
            {
                "pattern": "joker_scaling",
                "success_rate": 0.68,
                "occurrences": 32
            }
        ]
...
class TestGraphOptimizer:
    ...
    def test_analyzes_query_performance(self, optimizer):
        ...
        optimizer.client.execute_query.return_value = [
            {
                "query_pattern": "synergy_search",
                "avg_time_ms": 45,
                "call_count": 1200
            },
            {
                "query_pattern": "state_retrieval", 
                "avg_time_ms": 12,
                "call_count": 3400
            }
        ]
    ...
    @pytest.mark.parametrize("node_count,expected_action", [
        (10000, "none"),
        (100000, "cleanup_suggested"),
        (1000000, "cleanup_required")
    ])
