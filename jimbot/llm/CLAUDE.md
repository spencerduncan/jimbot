...
This document provides specific guidance for Claude/LangChain integration within
the JimBot LLM subsystem.

## Overview

The LLM subsystem provides strategic consultation for exploratory decisions and
meta-analysis of unsuccessful runs. It operates under strict rate limits (100
requests/hour) and must achieve <5% consultation rate for cost optimization.
