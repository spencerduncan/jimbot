...
This document provides Claude Code with guidance for deploying and scaling the
JimBot system.

## Deployment Overview

JimBot is designed for single-workstation deployment with specific resource
requirements:
