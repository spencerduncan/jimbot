...
class CIStatusReporter:
    ...
    def print_report(self, report: Dict):
        ...
        print(f"Success Rate: {report['overall']['rate']}% ({report['overall']['successful']}/{report['overall']['total']} runs)")
        print()
        ...
        if report["overall"]["rate"] < 70:
            ...
            print("   Consider investigating recent failures and infrastructure issues.")
