...
love.timer.getTime = function() return mock_time end
...
-- Mock logger
local mock_logger = {
    info = function(self, msg, data) print("[INFO] " .. msg) end,
    debug = function(self, msg, data) end,
    warn = function(self, msg, data) print("[WARN] " .. msg) end,
    error = function(self, msg, data) print("[ERROR] " .. msg .. " - " .. tostring(data and data.error or "")) end,
}
