...
_G.BalatroMCP = {
    components = {
        logger = {
            info = function(self, msg, data) print("[INFO] " .. msg .. (data and ": " .. vim.inspect(data) or "")) end,
            debug = function(self, msg, data) print("[DEBUG] " .. msg .. (data and ": " .. vim.inspect(data) or "")) end,
            warn = function(self, msg, data) print("[WARN] " .. msg .. (data and ": " .. vim.inspect(data) or "")) end,
        },
        aggregator = {
            ...
            flush = function(self) print("[AGGREGATOR] Flushing events") end,
        }
    }
}
