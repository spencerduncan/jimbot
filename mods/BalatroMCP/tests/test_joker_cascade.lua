...
function TestJokerCascade:test_complex_joker_cascade()
    ...
    lu.assertTrue(
        http_requests < num_triggers / 10,
        "Should be significantly fewer requests than events"
    )
end
...
function TestJokerCascade:test_mixed_priority_cascade()
    ...
    lu.assertTrue(
        http_requests <= 4,
        "Should batch efficiently even with high priority interruption"
    )
end
...
function TestJokerCascade:test_real_world_scenario()
    ...
    lu.assertTrue(
        http_requests <= expected_max_requests,
        "Should batch efficiently across multiple sequences"
    )
