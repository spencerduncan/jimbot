...
function BlindValidator:validate(action_data, game_state)
    ...
    if not blind_option then
        ...
        return ValidationResult.error(
            "Required blind '" .. required_blind .. "' not available. Available: " .. available_str
        )
    end
    ...
    if original_blind and original_blind ~= required_blind then
        print(
            "BalatroMCP: BlindValidator - Overriding agent blind selection '"
                .. original_blind
                .. "' with required progression blind '"
                .. required_blind
                .. "'"
        )
    else
