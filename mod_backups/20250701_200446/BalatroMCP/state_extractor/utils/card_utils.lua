...
function CardUtils.get_card_enhancement_safe(card)
    ...
    local ability_name =
        StateExtractorUtils.safe_primitive_nested_value(card, { "ability", "name" }, nil)
...
function CardUtils.extract_joker_properties_safe(joker)
    ...
    properties.mult =
        StateExtractorUtils.safe_primitive_nested_value(joker, { "ability", "mult" }, 0)
    properties.chips =
        StateExtractorUtils.safe_primitive_nested_value(joker, { "ability", "t_chips" }, 0)
