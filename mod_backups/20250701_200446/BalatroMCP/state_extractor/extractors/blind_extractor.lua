        ...
        if blind_on_deck then
            ...
            if StateExtractorUtils.safe_check_path(G, { "blind_select_opts" }) then
                ...
                if blind_option and blind_option.config and blind_option.config.blind then
                    ...
                    blind_info.name =
                        StateExtractorUtils.safe_primitive_value(blind_config, "name", "")
                    blind_info.requirement =
                        StateExtractorUtils.safe_primitive_value(blind_config, "chips", 0)
                    blind_info.reward =
                        StateExtractorUtils.safe_primitive_value(blind_config, "dollars", 0)
                end
            end
        end
    else
        ...
        if StateExtractorUtils.safe_check_path(G, { "blind_select_opts" }) then
            ...
            if G.blind_select_opts["big"] and G.blind_select_opts["small"] then
                ...
                if blind_option and blind_option.config and blind_option.config.blind then
                    local blind_config = blind_option.config.blind
                    blind_info.name =
                        StateExtractorUtils.safe_primitive_value(blind_config, "name", "Big Blind")
                    blind_info.requirement =
                        StateExtractorUtils.safe_primitive_value(blind_config, "chips", 0)
                    blind_info.reward =
                        StateExtractorUtils.safe_primitive_value(blind_config, "dollars", 0)
            ...
            elseif G.blind_select_opts["small"] then
                ...
                if blind_option and blind_option.config and blind_option.config.blind then
                    local blind_config = blind_option.config.blind
                    blind_info.name = StateExtractorUtils.safe_primitive_value(
                        blind_config,
                        "name",
                        "Small Blind"
                    )
            ...
            elseif G.blind_select_opts["boss"] then
                ...
                if blind_option and blind_option.config and blind_option.config.blind then
                    local blind_config = blind_option.config.blind
                    blind_info.name =
                        StateExtractorUtils.safe_primitive_value(blind_config, "name", "Boss Blind")
                    blind_info.requirement =
                        StateExtractorUtils.safe_primitive_value(blind_config, "chips", 0)
                    blind_info.reward =
                        StateExtractorUtils.safe_primitive_value(blind_config, "dollars", 0)
