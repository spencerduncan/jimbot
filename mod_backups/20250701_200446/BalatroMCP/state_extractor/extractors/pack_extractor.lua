...
function PackExtractor:extract_pack_card_data(card, index)
    ...
    local ability_set =
        StateExtractorUtils.safe_primitive_nested_value(card, { "ability", "set" }, "")
    ...
    -- Extract card name
    card_data.name =
        StateExtractorUtils.safe_primitive_nested_value(card, { "ability", "name" }, "Unknown")
...
function PackExtractor:extract_card_properties(card)
    ...
    local enhancement =
        StateExtractorUtils.safe_primitive_nested_value(card, { "config", "center", "key" }, nil)
    if enhancement then
